...
public class BookFlight extends JFrame implements ActionListener{
    ...
    public BookFlight() {
        ...
        ImageIcon image = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsys/icons/details.jpg"));
        JLabel lblimage = new JLabel(image);
        lblimage.setBounds(550,65,500,500);
        add(lblimage);
        ...
        if (ae.getSource() == fetchButton) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Flights not available!");                
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
